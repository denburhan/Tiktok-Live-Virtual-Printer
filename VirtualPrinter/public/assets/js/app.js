...
function addGift(data) {
    ...
    if (giftTotal >= 10) {
        ...
        // Add
        addContent(
            `<div style="text-align:center;font-size: 1.25rem;"><div style='padding-bottom:.5rem;'>Thank you <span style='font-weight: bold;'>`+userName+`!</span>
             <img src="`+userAvatar+`" style="width:128px;height:128px;border-radius: 15px;"/></div>
